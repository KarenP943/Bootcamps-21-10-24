...
const estudents_1 = require("./Entidades/estudents");
let AppController = class AppController {
    constructor(appService) {
        this.appService = appService;
    }
    getIdentificacion(id, name, tel, Age) {
        return new estudents_1.Student(id, name, tel, Age);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", estudents_1.Student)
